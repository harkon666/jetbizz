          ...
          <div className="absolute top-5 z-20 min-h-screen">
            ...
            <div>
              <div className="grid lg:grid-cols-2 bg-light-gray xl:mx-52 sm:mx-20">
                  ...
                  <div className="flex items-center">
                    <ul className="grid grid-cols-1 text-sm">
                      ...
                      <li className="flex justify-start items-center space-x-2">
                        ...
                        <p>Bvlgari 40ml Body Lotion, Ret Tea</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>Bvlgari 40ml Nourishing Face Emulsion, Red Tea</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>
                          Bvlgari 15ml Vapo Spray Jewel, Red Tea, Packed in
                      ...
                      <li className="flex justify-start items-center space-x-2">
                        ...
                        <p>Bvlgari 12 gr refreshing towel, Oshibori</p>
                      </li>
                    </ul>
                  </div>
                </div>
                <div>
                  <img
                    src={  "images/American-Airlines-confident-in-its-entertainment-s.webp"
                    }
                  ...
                  <div className="flex items-center">
                    <ul className="grid grid-cols-1 text-sm">
                      ...
                      <li className="flex justify-start items-center space-x-2">
                        ...
                        <p>Bvlgari 40ml Body Lotion, Red Tea</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>Bvlgari 40ml After Shave Balm, Red Tea</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>
                          Bvlgari 5ml Miniature Spray, Red Tea, Packed in a
                          Bvlgari Gift box
                        </p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
