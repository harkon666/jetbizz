export default function TravelKitAmenity() {
  return (
    <>
        ...
        <div className="relative">
          ...
          <div className="absolute top-5 z-20 min-h-screen">
            <div className="text-center text-light-gray py-10">
              ...
              <div className="lg:px-60 sm:px-20">
                <h1 className="xxs:text-3xl sm:text-4xl font-bold my-4">
                  Our Travel Kit Amenity
                </h1>
              </div>
            </div>
            <div>
              <div className="grid md:grid-cols-2 bg-light-gray xl:mx-52 sm:mx-10 xxs:mx-2">
                    ...
                    <ul className="grid grid-cols-1 text-sm">
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          ...
                          className="xxs:w-4 xxs:h-4 sm:w-8 sm:h-8 text-gold"
                          viewBox="0 0 24 24"
                        >
                          <path
                            fill="currentColor"
                        ...
                        <p className="xxs:text-sm sm:text-base">
                          Drawstring Bag
                        </p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                      ...
                      <li className="flex justify-start items-center space-x-2">
                        ...
                        <p className="xxs:text-sm sm:text-base">Tissue Pack</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <li className="flex justify-start items-center space-x-2">
                        ...
                        <p className="xxs:text-sm sm:text-base">Red Tea</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p className="xxs:text-sm sm:text-base">
                          Bvlgari 12 gr refreshing towel
                        </p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                        ...
                        <p className="xxs:text-sm sm:text-base">Oshibori</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p className="xxs:text-sm sm:text-base">
                          Bvlgari 40ml Nourishing Face Emulsion
                        </p>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="flex items-center">
                    <ul className="grid grid-cols-1 text-sm">
                      ...
                      <li className="flex justify-start items-center space-x-2">
                        ...
                        <p>Bvlgari 40ml After Shave Balm</p>
                      </li>
                      <li className="flex justify-start items-center space-x-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="sm:h-[30rem] xxs:h-[25rem]"></div>
    </>
  );
}
