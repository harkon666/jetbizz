        ...
        <section>
          <div className="min-h-screen bg-white py-20 text-semi-black">
            <figure className="relative">
              <img
                src={"https://jetbizzaviation.com/images/Helicopters/BELL 407/bell407.jpg"}
            ...
            <div className="bg-white max-w-screen-xl mx-auto my-20 grid lg:grid-cols-2 sm:grid-col-1 gap-10">
              <div className="relative">
                ...
                <img
                  src={
                    "https://jetbizzaviation.com/images/Helicopters/BELL 407/hillsboro-aviation-executive-charter-b407-cabin-detail-small-web-1200x800.jpg"
                  }
