...
import Image1 from "../../../public/images/Jets/Cessna Citation XLS/5e442edc68579197839539.jpg";
import Image2 from "../../../public/images/Jets/Cessna Citation XLS/Citation_XLS_Ext3-3-1024x723.jpg";
import Image3 from "../../../public/images/Jets/Cessna Citation XLS/images.jpeg";
            ...
            <div className="bg-white max-w-screen-xl mx-auto my-20 grid lg:grid-cols-2 sm:grid-col-1 gap-10">
              ...
              <div className="flex flex-col justify-center sm:px-20 lg:px-0">
                ...
                <div className="space-y-2 mb-4 text-base leading-relaxed tracking-wide">
                  <p>
                    The Cessna Citation Excel is an American midsize business
                    jet built by Cessna. Announced in October 1994, the Model
                    560XL first flew on February 29, 1996, certification was
                    granted in April 1998, and over 1,000 have been delivered.
                  </p>
                </div>
                <div>
                  <ul className="grid lg:grid-cols-2 sm:grid-cols-1 gap-4">
                    <OverviewList point="Crew: 1-2" />
                    <OverviewList point="Passengers: 9" />
                    <OverviewList point="Cabin Altitude: 6,800 ft" />
                    <OverviewList point="Interior Width: 5.5 ft" />
                    <OverviewList point="Exterior Height: 17.2 ft" />
                    <OverviewList point="Fuel Burn: 210 Gallons per Hour" />
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="w-full py-20 lg:px-32 sm:px-10">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 place-items-center gap-4">
                <div className="flex flex-col items-center p-10 w-full rounded-lg shadow-md border border-light-purple">
                  ...
                  <div className="flex flex-col items-center space-y-4 mt-6">
                    <h1 className="text-3xl font-bold">
                      3,940 <span className="text-sm">ft</span>
                    </h1>
                ...
                <div className="flex flex-col items-center p-10 w-full rounded-lg shadow-md border border-light-purple">
                  ...
                  <div className="flex flex-col items-center space-y-4 mt-6">
                    <h1 className="text-3xl font-bold">
                      2,843 <span className="text-sm">ft</span>
                    </h1>
                ...
                <div className="flex flex-col items-center p-10 w-full rounded-lg shadow-md border border-light-purple">
                  ...
                  <div className="flex flex-col items-center space-y-4 mt-6">
                    <h1 className="text-3xl font-bold">
                      6.740 <span className="text-sm">Lb</span>
                    </h1>
                ...
                <div className="flex flex-col items-center p-10 w-full rounded-lg shadow-md border border-light-purple">
                  ...
                  <div className="flex flex-col items-center space-y-4 mt-6">
                    <h1 className="text-3xl font-bold">
                      433 <span className="text-sm">kts</span>
                    </h1>
                    <p className="text-base">Cruise Speed</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center p-10 w-full rounded-lg shadow-md border border-light-purple">
                  ...
                  <div className="flex flex-col items-center space-y-4 mt-6">
                    <h1 className="text-3xl font-bold">
                      1,770 <span className="text-sm">nm</span>
                    </h1>
            ...
            <div className="w-full bg-light-gray py-20">
              <div className="text-center">
                ...
                <h1 className="text-4xl font-bold my-4">
                  Cessna Citation XLS Photo Gallery
                </h1>
              </div>
