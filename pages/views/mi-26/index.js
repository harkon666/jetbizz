...
import Image1 from "../../../public/images/Helicopters/MI 26/miil-mi-26-1.jpg";
import Image2 from "../../../public/images/Helicopters/MI 26/miil-mi-26-2.webp";
import Image3 from "../../../public/images/Helicopters/MI 26/Russian_Air_Force_Mi-26_Beltyukov.jpg";
          ...
          <div className="min-h-screen bg-white py-20 text-semi-black">
            ...
            <div className="bg-white max-w-screen-xl mx-auto my-20 grid lg:grid-cols-2 sm:grid-col-1 gap-10">
              ...
              <div className="flex flex-col justify-center sm:px-20 lg:px-0">
                ...
                <div className="space-y-2 mb-4 text-base leading-relaxed tracking-wide">
                  <p>
                    The Mil Mi-26 is a Soviet/Russian heavy transport
                    helicopter. Its product code is Izdeliye 90. Operated by
                    both military and civilian operators, it is the largest and
                    most powerful helicopter to have gone into serial
                    production.
                  </p>
                </div>
                <div>
            ...
            <div className="w-full py-20 lg:px-32 sm:px-10">
              <div className="text-sm font-bold text-center">
                ...
                <h1 className="text-4xl leading-tight mb-4">MI 26</h1>
              </div>
            ...
            <div className="w-full bg-light-gray py-20">
              <div className="text-center">
                ...
                <h1 className="text-4xl font-bold my-4">MI 26 Photo Gallery</h1>
              </div>
